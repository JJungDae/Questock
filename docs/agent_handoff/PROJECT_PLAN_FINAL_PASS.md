...
| B6: M3-01~05·07·15 + 배포 scaffold | M2 Gate | Implementation→Review | LLMClient·LiteLLM adapter·ChatService·핵심 UI·glossary·source detail 틀·Docker 초안 | mock·structured parse·error mapping·API·UI smoke·container start | R31·R42·R20·R59~R61 | fixed template·보류·단일 안전 화면 |
